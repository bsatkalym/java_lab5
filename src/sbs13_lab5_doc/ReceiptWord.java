...
public class ReceiptWord extends javax.swing.JFrame {
    ...
    class TThread1 extends Thread {
        ...
        public void run() {
            ...
            try {
                doc.getRange().replaceText("$nameP", jTextField_FIO.getText());
                doc.getRange().replaceText("$name", jTextField_FIO2.getText());
                doc.getRange().replaceText("$date", jTextField_Date.getText());
            } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jButton_Save.setBounds(630, 430, 80, 22);

        jTextField_FIO.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(jTextField_FIO);
        jTextField_FIO.setBounds(180, 280, 380, 40);

        jTextField_FIO2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(jTextField_FIO2);
        jTextField_FIO2.setBounds(100, 430, 270, 24);

        jTextField_Date.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(jTextField_Date);
        jTextField_Date.setBounds(420, 430, 160, 24);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sbs13_lab5_doc/scr.png"))); // NOI18N
